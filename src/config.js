module.exports = {
    ...
    sentences: [
        ...
        "are reckless and decided to have this little",
        ...
        "fought so hard they became",
        "collide so hard it smashed into",
        "fell in a radioactive container and came out",
        "snorted some weird stuff and hallucinated about seeing",
        "were punished by having",
        "were in the same pokeball for too much time",
        "were united by Dr. Frankenstein creating",
        "are afraid of",
        "achieved decoupling from",
        "made a threesome with",
        "were removed in the new generation but now there's",
    ]
}
